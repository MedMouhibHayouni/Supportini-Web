...
export class AdminComponent implements OnInit {
  ...
  constructor(private  act:ActivatedRoute,private authService:AuthService,private ScriptServiceService: ScriptServiceService,  private renderer: Renderer2,private userService: UserService) { }
